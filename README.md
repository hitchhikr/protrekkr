...
Notice that you'll need the SDL 2 (https://github.com/libsdl-org/SDL/tree/SDL2) dev library to compile the tracker, the replay routines themselves have no dependencies.<br>
> [!CAUTION]
